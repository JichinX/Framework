package me.xujichang.hybirdbase.temp;
...
public class DownLoadToolTemp {
    private static final String FILE_APK = ".apk";
    private static DownLoadToolTemp instance;
    ...
    private DownLoadToolTemp() {
        disposable = new CompositeDisposable();
    }

    protected DownLoadToolTemp(String pS) {

    }

    private DownLoadToolTemp init(Builder builder) {
    ...
    private static DownLoadToolTemp getInstance() {
        if (null == instance) {
            instance = new DownLoadToolTemp();
        }
        instance.clear();
        return instance;
    }
